...
- `react-frontend-developer` if production code defects blocked good tests
- `react-frontend-code-reviewer` after tests are in place and the slice is ready for review
